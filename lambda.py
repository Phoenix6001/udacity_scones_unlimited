"""
serializeImageData: serialize the image data
"""
...
{
    "image_data": "",
    "s3_bucket": "sagemaker-us-east-1-817873966447",
...
ENDPOINT = "image-classification-2023-02-02-08-21-24-462"
...
def lambda_handler(event, context):
    ...
    meets_threshold = (float(max(inferences)) > THRESHOLD)
